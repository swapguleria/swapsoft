<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        ...
        <span class="logo-lg"><b>Swap</b>Development</span>
    </a>
                            ...
                            <ul class="menu">
                                <li>{{-- start message --}}
                                    <a href="javascript:void(0);">
                                        <div class="pull-left">
                                            <img src="{{ URL::to('/public/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Support Team
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="pull-left">
                                            <img src="{{ URL::to('/public/img/user3-128x128.jpg') }}" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="pull-left">
                                            <img src="{{ URL::to('/public/img/user4-128x128.jpg') }}" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {{ $user = Auth::user()->name }} - {{ Auth::user()->designation }}
