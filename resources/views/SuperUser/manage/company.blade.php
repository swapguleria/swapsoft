                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" >
                                        <form action="{{ route('SU-NewCompany') }}" method="POST">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="nav-tabs-custom">
                                                ...
                                                <ul class="nav nav-tabs" id="AddUser">
                                                    ...
                                                    <li class="pull-right header"><input type="submit" class="btn btn-primary btn-flat" value="Register" ></li>
                                                </ul>
                                                <div class="tab-content" style="height: 300px !important">
                                                    ...
                                                    <div class="tab-pane" id="company-address">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="fa fa-bank fa-2x"></i></span>
                                                            <input type="text" name="address-line-1" class="form-control input-lg" placeholder="Address Line 1">
                                                        </div>
                                                        <br>
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="fa fa-bank fa-2x"></i></span>
                                                            <input class="form-control input-lg" name="address-line-2" placeholder="Address Line 2">
                                                        </div>
                                                        <br>
                                                        ...
                                                        <div class="input-group" style="width: 50%; float: left">
                                                            <span class="input-group-addon"><i class="fa fa-bank fa-2x"></i></span>
                                                            <input type="text" class="form-control input-lg" placeholder="State" name="state" >
                                                        </div>
                                                        <br><br><br>
                                                        <div class="input-group" style="width: 50%; float: left">
                                                            <span class="input-group-addon"><i class="fa fa-bank fa-2x"></i></span>
                                                            <input type="text" name="pin" class="form-control input-lg" placeholder="Zip Code">
                                                        </div>
                                                        <div class="input-group" style="width: 50%; float: left">
                                                            <span class="input-group-addon"><i class="fa fa-bank fa-2x"></i></span>
